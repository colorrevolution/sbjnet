...
def make_standard_text(font_path, text, shape, padding = 0.1, color = (0, 0, 0), init_fontsize = 100):
    ...
    canvas = ((1. - canvas.astype(np.float32) / 255.) * 255.).astype(np.uint8)

    return cv2.cvtColor(canvas, cv2.COLOR_GRAY2RGB) ,surf
