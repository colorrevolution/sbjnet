...
class datagen():
    ...
    def gen_srnet_data_with_background(self,classRate):
        ...
        while True:
            ...
            # if len(save_img_hull) > 1:
            #     for i in range(1,len(save_img_hull)):
            #         save_img_hull[0] = save_img_hull[0] +save_img_hull[i]
            img_hull = np.zeros(surf1.shape)
        ...
        return [i_s, i_s_complete,surf1,surf1, text1,img_hull,fontstr]
