...
class datagen():
    ...
    def gen_srnet_data_with_background(self):
        ...
        while True:
            ...
            i_t ,surf_i_t = render_standard_text.make_standard_text(self.standard_font_path, text2, (surf_h, surf_w))
            t_t ,surf_t_t = render_standard_text.make_standard_text(self.standard_font_path, text1, (surf_h, surf_w))
            ...
            t_t___, t_f = colorize.colorize(surf2, t_b, fg_col, bg_col, self.colorsRGB, self.colorsLAB, min_h, param)
            # skeletonization
            # t_sk = skeletonization.skeletonization(surf2, 127)
            t_sk = skeletonization.skeletonization(surf_t_t, 127)
            ...
            i_t = image_pool
            break
        return [i_t, i_s, t_sk, t_t, t_b, t_t, surf_t_t]
        # return [i_t, i_s, t_sk, t_t, t_b, t_f, surf2, full_image]
